...
import com.poloniex.api.client.future.model.request.future.UnsubscribeRequest;
...
import static com.poloniex.api.client.future.common.PoloApiConstants.EVENT_SUBSCRIBE;
import static com.poloniex.api.client.future.common.PoloApiConstants.EVENT_UNSUBSCRIBE;
...
public class PoloBaseWebsocketClient {
    ...
    public boolean subscribe(WebSocket webSocket, List<String> channels) {
        return subscribe(webSocket, channels, null, null, null, null, null, null, null, null);
    }
    ...
    public boolean subscribe(WebSocket webSocket, List<String> channels, List<String> symbols) {
        return subscribe(webSocket, channels, symbols, null, null, null, null, null, null, null);
    }
    ...
    public boolean subscribe(WebSocket webSocket, List<String> channels, List<String> symbols, Integer depth) {
        return subscribe(webSocket, channels, symbols, depth, null, null, null, null, null, null);
    }
    ...
    public boolean subscribe(WebSocket webSocket, List<String> channels, String key, Long signTimestamp, String signature) {
        return subscribe(webSocket, channels, null, null, key, signTimestamp, signature, null, null, null);
    }
    ...
    public <T> boolean subscribe(WebSocket webSocket, String id, String event, T params) {
        return subscribe(webSocket, null, null, null, null, null, null, id, event, params);
    }
     ...
     * @return success of subscription
     */
    public <T> boolean subscribe(WebSocket webSocket, List<String> channels, List<String> symbols, Integer depth, String key, Long signTimestamp, String signature, String id, String event, T params) {
