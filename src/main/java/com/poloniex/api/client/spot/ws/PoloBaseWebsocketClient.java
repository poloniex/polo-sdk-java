...
import com.poloniex.api.client.spot.model.request.spot.UnsubscribeRequest;
...
import static com.poloniex.api.client.spot.common.PoloApiConstants.EVENT_SUBSCRIBE;
import static com.poloniex.api.client.spot.common.PoloApiConstants.EVENT_UNSUBSCRIBE;
...
public class PoloBaseWebsocketClient {
    ...
    public boolean subscribe(WebSocket webSocket, List<String> channels) {
        return subscribe(webSocket, channels, null,null, null, null, null, null, null, null, null);
    }
    ...
    public boolean subscribe(WebSocket webSocket, List<String> channels, List<String> symbols) {
        if(symbols.get(0).contains("_")){
            return subscribe(webSocket, channels, symbols,null, null, null, null, null, null, null, null);
        }else{
            return subscribe(webSocket, channels, null, symbols,null, null, null, null, null, null, null);
        }
    ...
    public boolean subscribe(WebSocket webSocket, List<String> channels, List<String> symbols, Integer depth) {
        return subscribe(webSocket, channels, symbols,null, depth, null, null, null, null, null, null);
    }
    ...
    public boolean subscribe(WebSocket webSocket, List<String> channels, String key, Long signTimestamp, String signature) {
        return subscribe(webSocket, channels, null, null,null, key, signTimestamp, signature, null, null, null);
    }
     ...
     * @return success of subscription
     */
    public <T> boolean subscribe(WebSocket webSocket, String id, String event, T params) {
        return subscribe(webSocket, null, null,null, null, null, null, null, id, event, params);
    }
     ...
     * @return success of subscription
     */
    public <T> boolean subscribe(WebSocket webSocket, List<String> channels, List<String> symbols,List<String> currencies, Integer depth, String key, Long signTimestamp, String signature, String id, String event, T params) {
        SubscribeRequest<Object> subscribeRequest = SubscribeRequest.builder()
                .event(event==null? EVENT_SUBSCRIBE : event)
                .channel(channels)
                .symbols(symbols)
